...
```jsonc
{
  "cSpell.import": ["https://cdn.jsdelivr.net/npm/@cspell/dict-ca@latest/cspell-ext.json/cspell-ext.json"],
  "cSpell.language": "ca",
}
```
...
```jsonc
{
  "import": ["https://cdn.jsdelivr.net/npm/@cspell/dict-ca@latest/cspell-ext.json/cspell-ext.json"],
  "language": "ca",
}
```
