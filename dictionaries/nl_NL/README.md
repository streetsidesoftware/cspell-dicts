...
```jsonc
{
  "cSpell.import": ["https://cdn.jsdelivr.net/npm/@cspell/dict-nl-nl/cspell-ext.json"],
  "cSpell.language": "nl, nl-NL",
}
```
...
```jsonc
{
  "import": ["https://cdn.jsdelivr.net/npm/@cspell/dict-nl-nl/cspell-ext.json"],
  "language": "nl, nl-NL",
}
```
...
```yaml
import:
  - https://cdn.jsdelivr.net/npm/@cspell/dict-nl-nl/cspell-ext.json
language: nl, nl-NL
```
