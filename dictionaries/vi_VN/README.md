...
```jsonc
{
  "cSpell.import": ["https://cdn.jsdelivr.net/npm/@cspell/dict-vi-vn/cspell-ext.json"],
  "cSpell.language": "vi",
}
```
...
```jsonc
{
  "import": ["https://cdn.jsdelivr.net/npm/@cspell/dict-vi-vn/cspell-ext.json"],
  "language": "vi",
}
```
...
```yaml
import:
  - https://cdn.jsdelivr.net/npm/@cspell/dict-vi-vn/cspell-ext.json
language: vi
```
