...
```jsonc
{
  "cSpell.import": ["https://cdn.jsdelivr.net/npm/@cspell/dict-pt-pt/cspell-ext.json"],
  "cSpell.language": "pt, pt_PT",
}
```
...
```jsonc
{
  "import": ["https://cdn.jsdelivr.net/npm/@cspell/dict-pt-pt/cspell-ext.json"],
  "language": "pt, pt_PT",
}
```
...
```yaml
import:
  - https://cdn.jsdelivr.net/npm/@cspell/dict-pt-pt/cspell-ext.json
language: pt, pt_PT
```
