...
```jsonc
{
  "cSpell.import": ["https://cdn.jsdelivr.net/npm/@cspell/dict-fi-fi/cspell-ext.json"],
  "cSpell.language": "fi, fi-fi",
}
```
...
```jsonc
{
  "import": ["https://cdn.jsdelivr.net/npm/@cspell/dict-fi-fi/cspell-ext.json"],
  "language": "fi, fi-fi",
}
```
...
```yaml
import:
  - https://cdn.jsdelivr.net/npm/@cspell/dict-fi-fi/cspell-ext.json
language: fi, fi-fi
```
