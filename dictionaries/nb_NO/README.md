...
```jsonc
{
  "cSpell.import": ["https://cdn.jsdelivr.net/npm/@cspell/dict-nb-no/cspell-ext.json"],
  "cSpell.language": "nb, nb-no",
}
```
...
```jsonc
{
  "import": ["https://cdn.jsdelivr.net/npm/@cspell/dict-nb-no/cspell-ext.json"],
  "language": "nb, nb-no",
}
```
...
```yaml
import:
  - https://cdn.jsdelivr.net/npm/@cspell/dict-nb-no/cspell-ext.json
language: nb, nb-no
```
