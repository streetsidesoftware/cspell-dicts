...
Please add any words to [src/additional\_words.txt](https://github.com/streetsidesoftware/cspell-dicts/blob/main/dictionaries/gl_ES/src/additional_words.txt) by making a pull request.
