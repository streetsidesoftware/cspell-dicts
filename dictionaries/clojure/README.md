...
```jsonc
{
  "cSpell.import": ["https://cdn.jsdelivr.net/npm/@cspell/dict-clojure/cspell-ext.json"],
  "cSpell.dictionaries": ["clojure"],
}
```
...
```jsonc
{
  "import": ["https://cdn.jsdelivr.net/npm/@cspell/dict-clojure/cspell-ext.json"],
  "dictionaries": ["clojure"],
}
```
...
```yaml
import:
  - https://cdn.jsdelivr.net/npm/@cspell/dict-clojure/cspell-ext.json
dictionaries:
  - clojure
```
