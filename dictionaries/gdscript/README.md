...
```jsonc
{
  "cSpell.import": ["https://cdn.jsdelivr.net/npm/@cspell/dict-gdscript@1/cspell-ext.json"],
  "cSpell.dictionaries": ["gdscript"],
}
```
...
```jsonc
{
  "import": ["https://cdn.jsdelivr.net/npm/@cspell/dict-gdscript@1/cspell-ext.json"],
  "dictionaries": ["gdscript"],
}
```
...
```yaml
import:
  - https://cdn.jsdelivr.net/npm/@cspell/dict-gdscript@1/cspell-ext.json
dictionaries:
  - gdscript
```
