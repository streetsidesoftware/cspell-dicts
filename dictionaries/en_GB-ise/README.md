...
```jsonc
{
  "cSpell.import": ["https://cdn.jsdelivr.net/npm/@cspell/dict-en-gb-ise/cspell-ext.json"],
  "cSpell.language": "en-GB",
}
```
...
```jsonc
{
  "import": ["https://cdn.jsdelivr.net/npm/@cspell/dict-en-gb-ise/cspell-ext.json"],
  "language": "en-GB",
}
```
...
```yaml
import:
  - https://cdn.jsdelivr.net/npm/@cspell/dict-en-gb-ise/cspell-ext.json
language: en-GB
```
